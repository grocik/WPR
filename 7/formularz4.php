<form action="formularz4.php"  method="GET">
<table>
<tr><td><label for="wypelnij"></label></td></tr>
...
<tr><td>Podaj dane osobowe czwartej osoby; </td></tr>
<tr><td>Imie: *<INPUT REQUIRED TYPE="TEXT" name="imie3"></td></tr>
<tr><td>nazwisko: *<INPUT REQUIRED TYPE="TEXT" name="nazwisko3"></td></tr>
<tr><td>Adres: *<INPUT REQUIRED TYPE="TEXT" name="adres3"></td></tr>
<tr><td>wiek <INPUT  TYPE="TEXT" name="wiek3"></td></tr>
<tr><td><input type="radio" name="plec3" value="Mezczyzna"> Mezczyzna<td></tr>
<tr><td><input type="radio" name="plec3" value="Kobieta"> Kobieta<td></tr>
